...
print('FP of Age of young:', FPR_)
print('FN of Age of young:', (1-TPR_))
...
print('FP of Age of Adult:', FPR_)
print('FN of Age of Adult:', (1-TPR_))
...
print('FP of Sex of Male:', FPR_)
print('FN of Sex of Male:', (1-TPR_))
...
print('FP of Sex of Female:', FPR_)
print('FN of Sex of Female:', (1-TPR_))
